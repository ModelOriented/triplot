...
apartments_ai <- aspect_importance(x = model_apartments, data = apartments_no_target, new_observation = new_observation_apartments, variable_groups = aspects_apartments, N = 500, show_cor = TRUE)
apartments_ai
```
...
```{r}
tri <- calculate_triplot(model_apartments, apartments_no_target, 
