...
```{r triplot}
tri_lm <- calculate_triplot(Boston_lm, Boston_no_target, predict_function = predict, 
        new_observation = new_observation, N = 10000, add_importance_labels = TRUE, 
        axis_lab_size = 8, text_size = 3)
plot(tri_lm)

tri_rf <- calculate_triplot(Boston_rf, Boston_no_target, predict_function = predict, 
        new_observation = new_observation, N = 10000, add_importance_labels = TRUE, 
        axis_lab_size = 8, text_size = 3)
plot(tri_rf)
